    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#020617] text-slate-900 dark:text-slate-200 transition-colors duration-300">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-2 group">
            ...
            <h1 className="text-xl font-black tracking-tighter dark:text-white">
              ...
              <span className="ml-2 text-[10px] bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 px-2 py-0.5 rounded-md uppercase tracking-widest font-bold">Forge</span>
            </h1>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-3xl mx-auto p-6 md:p-12">
        <div className="mb-10">
          ...
          <p className="text-slate-500 dark:text-slate-400 font-medium">Configure a new workspace initiative and assign leadership.</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] p-8 md:p-10 shadow-xl dark:shadow-none relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {/* Description */}
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Strategy & Objectives</label>
              <div className="relative group">
            ...
            {/* Manager ID */}
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Lead Manager Assignment</label>
              <div className="relative group">
